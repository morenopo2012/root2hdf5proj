#ifndef ENHMASTERANADEV_H
#define ENHMASTERANADEV_H 1

#include "MasterAnaDev.h"
#include <vector>
#include <string>

// "Enhanced" MasterAnaDev ...
//
// Add helper methods here so we can re-create the MasterAnaDev.h with MakeClass
// at any time.
//
...
namespace RECOTRACKS_ANA {
  ...
  class EnhMasterAnaDev : public MasterAnaDev {

    public:
      EnhMasterAnaDev(TTree *t) :
        MasterAnaDev(t), m_numberOfBuckets(127),
